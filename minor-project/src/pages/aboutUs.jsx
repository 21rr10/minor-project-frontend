  ...
  return (
    <div className="min-h-screen bg-indigo-50" style={{
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h2 className="text-3xl font-bold text-indigo-900 mb-6">Welcome to Way-visor - Your Personal Travel Advisor</h2>
        
        <p className="text-lg text-gray-700 mb-8">
          At Way-visor, we believe that every journey should be as unique as the traveler. Our mission is to revolutionize the way you plan and experience your trips with our cutting-edge AI-powered travel planner.
        </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Way-visor harnesses the power of advanced AI to create customized itineraries that evolve in real-time. By analyzing your preferences, live traffic conditions, weather updates, we ensure that your travel plans are always optimized for the best possible experience.
          </p>
          <p className="text-gray-700">
            Our cloud-based platform seamlessly integrates various data streams to provide you with up-to-the-minute information, allowing you to make informed decisions for your journey. Whether you're looking for the perfect restaurant, seeking out hidden gems, or need to adjust your plans, Way-visor has got you covered.
          </p>
        </div>

        <div className="bg-white rounded-lg shadow-md p-8">
          <h3 className="text-2xl font-semibold text-indigo-800 mb-4">Why Choose Way-visor?</h3>
          ...
          <p className="text-gray-700 italic border-l-4 border-indigo-500 pl-4 py-2">
            At Way-visor, we're not just about planning trips; we're about crafting experiences. Let us be your guide to a world of seamless, personalized travel. Get your trip advice with Way-visor and embark on journeys that are truly your own.
          </p>
        </div>
      </div>
    </div>
