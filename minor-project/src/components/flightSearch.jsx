...
const FlightSearchComponent = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-4xl mx-auto">
      {/* Flight Search Row */}
      <div className="flex flex-wrap md:flex-nowrap items-center bg-gray-100 p-4 rounded-md">
        {/* FROM Section */}
        <div className="flex-1 p-4 relative border-r border-gray-300">
          <div className="text-xs text-gray-500 uppercase font-medium">From</div>
          <div className="text-xl font-semibold">Delhi</div>
          <div className="text-sm text-gray-600">[DEL] Indira Gandhi International Airport</div>
          
          {/* Swap Button */}
          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/2 z-10">
            <button className="bg-white border border-gray-300 rounded-full p-1 shadow-md text-gray-500 w-7 h-7 flex items-center justify-center">
              ⇄
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 p-4 border-r border-gray-300">
          ...
          <div className="text-sm text-gray-600">[BOM] Chhatrapati Shivaji International Airport</div>
        </div>
      ...
      <div className="mt-6 flex justify-center">
        <button className="bg-black text-white py-3 px-10 rounded-lg text-lg font-semibold shadow-md hover:bg-gray-800 transition duration-200">
          TAKE ME THERE
        </button>
      </div>
    </div>
